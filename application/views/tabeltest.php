				...
				<div class="table-responsive">
					<table class="table table-bordered">
						<tr>
							...
							<td><strong>Sentimen Hasil Analisis POLITIK</strong></td>
							<td><strong>Sentimen Hasil Analisis OLAHRAGA</strong></td>
						</tr>
						<tr>
							<td><strong>KLASIFIKASI POLITIK</strong></td>
						...
						<tr>
							<td><strong>KLASIFIKASI OLAHRAGA</strong></td>
						...
						<tr>
							<td><strong>KLASIFIKASI KESEHATAN</strong></td>
							<td><strong>F</strong>alse <strong>P</strong>ositives = <span id="false-positives"></span></td>
							<td><strong>T</strong>rue <strong>N</strong>egatives = <span id="true-negatives"></span></td>
						</tr>
						<tr>
							<td><strong>KLASIFIKASI PENDIDIKAN</strong></td>
							<td><strong>F</strong>alse <strong>P</strong>ositives = <span id="false-positives"></span></td>
							<td><strong>T</strong>rue <strong>N</strong>egatives = <span id="true-negatives"></span></td>
						</tr>
						<tr>
							<td><strong>KLASIFIKASI ENTERTAINMENT</strong></td>
							<td><strong>F</strong>alse <strong>P</strong>ositives = <span id="false-positives"></span></td>
							<td><strong>T</strong>rue <strong>N</strong>egatives = <span id="true-negatives"></span></td>
						</tr>
						<tr>
							<td><strong>KLASIFIKASI BISNIS</strong></td>
							<td><strong>F</strong>alse <strong>P</strong>ositives = <span id="false-positives"></span></td>
							<td><strong>T</strong>rue <strong>N</strong>egatives = <span id="true-negatives"></span></td>
						</tr>
						<tr>
							<td><strong>KLASIFIKASI TEKNOLOGI</strong></td>
							<td><strong>F</strong>alse <strong>P</strong>ositives = <span id="false-positives"></span></td>
							<td><strong>T</strong>rue <strong>N</strong>egatives = <span id="true-negatives"></span></td>
						</tr>
					</table>
